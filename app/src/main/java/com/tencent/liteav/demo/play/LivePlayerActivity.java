...
//                param.putInt(TXINotifyListener.EVT_ID, 2105);
//                param.putLong(TXINotifyListener.EVT_TIME, TXCTimeUtil.getTimeTick());
//                String description = getRandomNum();
//                param.putCharSequence(TXINotifyListener.EVT_DESCRIPTION, description);
//                mPlayVisibleLogView.setLogText(null, param, 2105);
//            }
//        });
...
//        return String.format("当前视频播放出现卡顿%sms", num);
//    }
